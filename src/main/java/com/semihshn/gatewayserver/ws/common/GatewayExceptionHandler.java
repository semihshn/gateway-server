...
import com.semihshn.gatewayserver.entities.exception.SemRefreshTokenException;
...
public class GatewayExceptionHandler {
    ...
    @ExceptionHandler(SemRefreshTokenException.class)
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    public ExceptionResponse handleRefreshTokenException(SemRefreshTokenException e) {
        return new ExceptionResponse(e.getExceptionType(), e.getDetail());
    }
}
